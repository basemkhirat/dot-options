                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <label for="facebook_page">
                                                        ...
                                                        {{ trans("options::options.attributes.facebook_page") }}
                                                    </label>
                                                    <input name="facebook_page" type="url"
                                                           value="{{ @Request::old("facebook_page", Config::get("facebook_page")) }}"
                                                ...
                                                <div class="form-group">
                                                    <label for="twitter_page">
                                                        ...
                                                        {{ trans("options::options.attributes.twitter_page") }}
                                                    </label>
                                                    <input name="twitter_page" type="url"
                                                           value="{{ @Request::old("twitter_page", Config::get("twitter_page")) }}"
                                                ...
                                                <div class="form-group">
                                                    <label for="googleplus_page">
                                                        ...
                                                        {{ trans("options::options.attributes.googleplus_page") }}
                                                    </label>
                                                    <input name="googleplus_page" type="url"
                                                           value="{{ @Request::old("googleplus_page", Config::get("googleplus_page")) }}"
                                                ...
                                                <div class="form-group">
                                                    <label for="youtube_page">
                                                        ...
                                                        {{ trans("options::options.attributes.youtube_page") }}
                                                    </label>
                                                    <input name="youtube_page" type="url"
                                                           value="{{ @Request::old("youtube_page", Config::get("youtube_page")) }}"
                                                ...
                                                <div class="form-group">
                                                    <label for="instagram_page">
                                                        ...
                                                        {{ trans("options::options.attributes.instagram_page") }}
                                                    </label>
                                                    <input name="instagram_page" type="url"
                                                           value="{{ @Request::old("instagram_page", Config::get("instagram_page")) }}"
                                                ...
                                                <div class="form-group">
                                                    <label for="soundcloud_page">
                                                        ...
                                                        {{ trans("options::options.attributes.soundcloud_page") }}
                                                    </label>
                                                    <input name="soundcloud_page" type="url"
                                                           value="{{ @Request::old("soundcloud_page", Config::get("soundcloud_page")) }}"
                                                ...
                                                <div class="form-group">
                                                    <label for="linkedin_page">
                                                        ...
                                                        {{ trans("options::options.attributes.linkedin_page") }}
                                                    </label>
                                                    <input name="linkedin_page" type="url"
                                                           value="{{ @Request::old("linkedin_page", Config::get("linkedin_page")) }}"
