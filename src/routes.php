...
Route::group(array(
    ...
    $route->group(array("prefix" => "options"), function($route) {
        $route->any('/', array("as" => "admin.options.show", "uses" => "Dot\Options\Controllers\OptionsController@index"));
        $route->any('/seo', array("as" => "admin.options.seo", "uses" => "Dot\Options\Controllers\OptionsController@seo"));
        $route->any('/modules', array("as" => "admin.options.modules", "uses" => "Dot\Options\Controllers\OptionsController@modules"));
        $route->any('/media', array("as" => "admin.options.media", "uses" => "Dot\Options\Controllers\OptionsController@media"));
        $route->any('/social', array("as" => "admin.options.social", "uses" => "Dot\Options\Controllers\OptionsController@social"));
